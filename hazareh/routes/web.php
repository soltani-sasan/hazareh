...
Route::get('/staff/research', [PageController::class, 'staffResearch'])->name('staff.research');
Route::get('/staff/admin', [PageController::class, 'staffAdmin'])->name('staff.admin');
...
// ── Registration ──────────────────────────────────────────
Route::get('/pre-register', [RegistrationController::class, 'form'])->name('pre-register');
