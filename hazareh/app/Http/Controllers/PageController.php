...
class PageController extends Controller
{
    ...
    {
        $staff = Staff::where('department', 'research')->where('is_active', 1)->orderBy('sort_order')->get();
        return view('pages.staff', ['staff' => $staff, 'title' => 'کادر پژوهشی', 'department' => 'research']);
    }
